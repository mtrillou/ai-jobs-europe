...
| **NLP Research Engineer** | LightOn | Paris, France | Hybrid | [View →](https://tietalent.com/en/jobs/nlp-engineer/remote) |
...
| **Senior AI Engineer** | Cohere | Remote — Europe | Full remote | [View →](https://tietalent.com/en/jobs/ai-engineer/remote) |
| **AI Research Engineer** | EPFL | Lausanne, Switzerland | On-site | [View →](https://tietalent.com/en/jobs/ai-engineer/lausanne) |
| **NLP Engineer** | DeepL | Cologne, Germany | Hybrid | [View →](https://tietalent.com/en/jobs/nlp-engineer/remote) |
| **Computer Vision Engineer** | Prophesee | Paris, France | Hybrid | [View →](https://tietalent.com/en/jobs/computer-vision-engineer/remote) |
...
The European AI job market is growing faster than any other engineering discipline. France, Switzerland, and Germany are home to world-class AI labs and production teams. Demand for LLM engineers, MLOps specialists, and AI platform engineers is significantly outpacing supply — giving qualified candidates strong negotiating leverage.

> **Trending now:** LLM engineering, RAG pipelines, and AI safety roles are seeing the fastest growth in postings this quarter.
